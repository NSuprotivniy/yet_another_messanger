...
public class CassandraUser extends Cassandra {
    ...
    public String getAuth(String mail, String pass)
    {
        try {
            ColumnFamilyResult<String, String> res = template.queryColumns(mail);
            String password = res.getString("password_digest");
